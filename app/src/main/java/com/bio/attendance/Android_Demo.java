 ...
 * -------------------------------------------------
 */
public class Android_Demo extends Activity implements NBioBSPJNI.CAPTURE_CALLBACK, SampleDialogFragment.SampleDialogListener, UserDialog.UserDialogListener {
